...
export const products: Product[] = [
  ...
  { id: "n3", name: "Composition Notebook (5-pack)", price: 140, image: "https://images.unsplash.com/photo-1541963463532-d68292c34b19?w=300", category: "notebooks", rating: 4.7, sold: 3800, description: "Standard 80-leaf composition notebooks in assorted colors." },
  ...
  { id: "10", name: "Highlighter Set (6 Neon)", price: 95, image: "https://images.unsplash.com/photo-1585336261022-680e295ce3fe?w=300", category: "pens", rating: 4.7, sold: 8900, description: "Bright neon highlighters perfect for studying and marking textbooks." },
  { id: "14", name: "Correction Tape (3-pack)", price: 55, image: "https://images.unsplash.com/photo-1586075010923-2dd4570fb338?w=300", category: "pens", rating: 4.8, sold: 7800, description: "Smooth correction tape for clean, neat corrections." },
  ...
  // Bags
  { id: "3", name: "Student Backpack - Waterproof", price: 499, image: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=300", category: "bags", rating: 4.7, sold: 1200, description: "Durable waterproof backpack with laptop compartment and multiple pockets." },
  ...
  { id: "b3", name: "Lunch Bag Insulated", price: 180, image: "https://images.unsplash.com/photo-1622560480605-d83c661a4293?w=300", category: "bags", rating: 4.6, sold: 1800, description: "Keep your baon fresh with this insulated lunch bag." },
  ...
  { id: "bk3", name: "STEM Review Workbook", price: 350, image: "https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=300", category: "books", rating: 4.8, sold: 1560, description: "Practice workbook for STEM students with solved examples.", isFlashSale: false },

  // Art Supplies
  { id: "5", name: "Watercolor Paint Set (24 Colors)", price: 320, image: "https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=300", category: "art", rating: 4.6, sold: 780, description: "Professional-grade watercolor paints in a portable palette. 24 vivid colors." },
  ...
  { id: "a3", name: "Colored Pencil Set (36pcs)", price: 250, image: "https://images.unsplash.com/photo-1513542789411-b6a5d4f31634?w=300", category: "art", rating: 4.7, sold: 2100, description: "Vibrant pre-sharpened colored pencils in a tin case." },
  ...
  // Tech & Gadgets
  { id: "4", name: "Scientific Calculator FX-991", price: 650, image: "https://images.unsplash.com/photo-1564466809058-bf4114d55352?w=300", category: "tech", rating: 4.9, sold: 890, description: "Advanced scientific calculator for math, physics and engineering students.", isFlashSale: false },
  { id: "8", name: "USB Flash Drive 32GB", price: 350, image: "https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?w=300", category: "tech", rating: 4.7, sold: 4500, description: "Fast USB 3.0 flash drive. Store all your school files safely.", isFlashSale: false },
  { id: "15", name: "Laptop Sleeve 14-inch", price: 399, image: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=300", category: "tech", rating: 4.6, sold: 2100, description: "Padded laptop sleeve with water-resistant exterior." },
  { id: "t4", name: "Wired Earphones with Mic", price: 150, image: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=300", category: "tech", rating: 4.3, sold: 6700, description: "Clear sound earphones perfect for online classes and music." },
  ...
  // Uniforms
  { id: "7", name: "PE Uniform Set", price: 450, image: "https://images.unsplash.com/photo-1524805444758-089113d48a6d?w=300", category: "uniforms", rating: 4.3, sold: 670, description: "Complete PE uniform set including shirt and shorts." },
  ...
  { id: "s2", name: "Badminton Racket (Pair)", price: 500, image: "https://images.unsplash.com/photo-1626224583764-f87db24ac4ea?w=300", category: "sports", rating: 4.6, sold: 890, description: "Lightweight racket pair with 3 shuttlecocks included." },
  ...
  { id: "sn2", name: "Chocolate Milk Drink (6-pack)", price: 90, image: "https://images.unsplash.com/photo-1563636619-e9143da7973b?w=300", category: "snacks", rating: 4.8, sold: 8500, description: "Creamy chocolate milk in convenient ready-to-drink packs.", isFlashSale: false },
  ...
  { id: "ac2", name: "Wristwatch - Digital Student", price: 350, image: "https://images.unsplash.com/photo-1524805444758-089113d48a6d?w=300", category: "accessories", rating: 4.6, sold: 1900, description: "Water-resistant digital watch with alarm and stopwatch features." },
  ...
  { id: "hy3", name: "Face Mask (50pcs Box)", price: 200, image: "https://images.unsplash.com/photo-1584634731339-252c581abfc5?w=300", category: "hygiene", rating: 4.5, sold: 5600, description: "3-ply disposable face masks for everyday protection." },
